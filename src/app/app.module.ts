...
@NgModule({
  declarations: [AppComponent,LoginComponent,FooterComponent,SnackbarComponent,PasswordForgetComponent,SkillComponent,HomeComponent,ProfileComponent,StatComponent,AutoEvalComponent],
  entryComponents: [],
